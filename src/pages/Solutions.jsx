...
export default function Solutions() {
  return (
    <>
      ...
      <section className="relative min-h-[72vh] bg-[#07192E] overflow-hidden flex items-center">

        {/* Decorative circles */}

        <div className="absolute -top-48 -right-48 w-[650px] h-[650px] rounded-full border border-cyan-400/10"></div>

        <div className="absolute top-24 right-24 w-[320px] h-[320px] rounded-full border border-cyan-400/10"></div>

        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] rounded-full bg-cyan-500/5 blur-3xl"></div>

        <div className="absolute inset-0 bg-gradient-to-r from-[#07192E] via-[#07192E]/95 to-[#07192E]/80"></div>
            ...
            >
              ...
              {[
                ...
                >
                  ...
                  <div className="text-4xl font-black text-cyan-100 group-hover:text-cyan-200 transition">
                    0{index + 1}
                  </div>

                  <p className="mt-5 text-lg font-bold text-[#07192E] leading-7">
                    {item}
                  </p>
            ...
            {advantages.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-7 text-xl font-black text-[#07192E]">
                    {item.title}
                  </h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 mt-8">
                    ...
                    <h3 className="text-2xl font-black text-[#07192E]">
                      {item.title}
                    </h3>

                    <p className="mt-2 text-cyan-600 font-semibold text-sm">
                      {item.subtitle}
                    </p>
      ...
      <section className="py-24 bg-[#07192E]">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full border border-white/20"></div>
            ...
            <div className="relative z-10">
              ...
              <p className="mt-7 max-w-2xl mx-auto text-lg leading-8 text-cyan-50">
