...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-[#021322]/70"
        aria-hidden="true"
      />
      ...
      <div
        className="absolute inset-0 bg-gradient-to-r from-[#021322] via-[#021322]/85 to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="relative z-20 max-w-7xl mx-auto h-full flex items-center px-6 lg:px-10">
        ...
        <div className="max-w-2xl">
          ...
          >
            VS Enterprises provides reliable industrial automation solutions
            in Ludhiana, Punjab, including Siemens and Delta PLCs, HMIs,
            AC Drives, Servo Systems and complete factory automation solutions
